...
/**************************************************************
	...
	Version		: 1.4 (Modified by Giovanni Granata for Esseitalia)
	Authors		: Samuel Birch  (Modified by Giovanni Granata for Esseitalia)
		...
		this.tHead.getElements('th').each(function(el,i){
			if(el.axis){
				...
				el.compare = function(a,b){
					...
					if(el.axis == 'number'){	
						//alert('A[V1='+var1+' V2='+var2+']');	
						
						//Grn mod. In case of empty, not valid, unparseable value... a -1 is considered as order
